...
INSERT INTO `orderitems` VALUES (12,16,14,00000000020,'2018-08-24 13:37:06','2018-08-24 13:37:06'),(13,17,14,00000000020,'2018-08-24 13:37:06','2018-08-24 13:37:06'),(14,16,15,00000000050,'2018-08-24 13:39:57','2018-08-24 13:39:57'),(15,17,15,00000000050,'2018-08-24 13:39:57','2018-08-24 13:39:57'),(16,16,17,00000000001,'2018-08-24 14:02:43','2018-08-24 14:02:43'),(17,17,17,00000000004,'2018-08-24 14:02:43','2018-08-24 14:02:43'),(18,16,18,00000000001,'2018-08-24 16:32:19','2018-08-24 16:32:19'),(19,17,18,00000000001,'2018-08-24 16:32:19','2018-08-24 16:32:19');
...
INSERT INTO `orders` VALUES (13,3,3,'2018-08-24 13:32:00','2018-08-24 13:32:00','0'),(14,3,3,'2018-08-24 13:37:06','2018-08-24 13:37:06','0'),(15,3,3,'2018-08-24 13:39:57','2018-08-24 13:39:57','0'),(17,3,3,'2018-08-24 14:02:43','2018-08-24 14:02:43','0'),(18,3,3,'2018-08-24 16:32:19','2018-08-24 16:32:19','0');
...
INSERT INTO `users` VALUES (3,'userbeli','user','beli','batam','$2b$05$mMFwxg6Uj84OlURx9mvpse5DU/LTgeJ1ZvT5.s2oeIXPDoScG0SMq','userbeli@example.com','081212121212','2018-08-24 12:53:44','2018-08-24 12:53:44'),(4,'wibisono','wibisono','heru',NULL,'$2b$05$hWwZdiSrCLphiDnQcMAED.quH6LqhozzDXBWCIxKK5BWprzWggtXe','heru@gmail.com',NULL,'2018-08-24 16:18:14','2018-08-24 16:18:14');
...
--
-- Temporary view structure for view `view_ordercomplete`
--

DROP TABLE IF EXISTS `view_ordercomplete`;
/*!50001 DROP VIEW IF EXISTS `view_ordercomplete`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `view_ordercomplete` AS SELECT 
 1 AS `idorder`,
 1 AS `status`,
 1 AS `nameproduct`,
 1 AS `priceproduct`,
...
--
-- Final view structure for view `view_ordercomplete`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`indr`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_ordercomplete` AS select `b`.`idorder` AS `idorder`,`a`.`status` AS `status`,`c`.`name` AS `nameproduct`,`c`.`price` AS `priceproduct`,`b`.`qty` AS `qtyproduct`,(`c`.`price` * `b`.`qty`) AS `totalproduct`,`d`.`username` AS `namecourier`,`d`.`price` AS `pricecourier`,`e`.`username` AS `nameseller`,`e`.`address` AS `addressseller`,`e`.`phone` AS `phoneseller`,`f`.`username` AS `nameuser`,`f`.`address` AS `addressuser`,`f`.`phone` AS `phoneuser` from (((((`orders` `a` left join `orderitems` `b` on((`a`.`id` = `b`.`idorder`))) left join `products` `c` on((`c`.`id` = `b`.`idproduct`))) left join `couriers` `d` on((`d`.`id` = `a`.`idcourier`))) left join `sellers` `e` on((`e`.`id` = `c`.`idseller`))) left join `users` `f` on((`f`.`id` = `a`.`iduser`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-08-25  7:52:37
